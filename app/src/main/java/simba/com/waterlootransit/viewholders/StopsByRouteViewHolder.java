...
import simba.com.waterlootransit.util.DBUtils;
import simba.com.waterlootransit.util.DateTimeUtil;
...
public class StopsByRouteViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void showStopDetails() {
        ...
        Intent stopDetailsIntent = new Intent("simba.com.waterlootransit.STOP_TIMES");
    ...
    private void showUpcomingStopTimes() {
        ...
        Intent intent = new Intent("simba.com.waterlootransit.STOP_INFO");
