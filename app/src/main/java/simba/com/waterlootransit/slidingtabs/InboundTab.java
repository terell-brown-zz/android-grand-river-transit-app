package simba.com.waterlootransit.slidingtabs;
...
import simba.com.waterlootransit.adapters.StopsByRouteAdapter;
...
public class InboundTab extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.fab_to:
                Intent showMapsIntent = new Intent("simba.com.waterlootransit.MAP_STOPS");
